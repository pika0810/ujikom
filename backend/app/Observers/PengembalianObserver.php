...
class PengembalianObserver
{
    ...
    {
        $this->catatLog("Memproses pengembalian alat untuk Peminjaman ID:
    ...
    public function updated(Pengembalian $pengembalian): void
    {
        ...
        ['updated_at']);
            ...
            if (!empty($perubahan)) {
                ...
                $this->catatLog("Merevisi data pengembalian (ID Kembali:
                #{$pengembalian->id}, Peminjaman ID: #{$pengembalian->peminjaman_id},
                Kolom diubah: {$kolom})");
        }
    }

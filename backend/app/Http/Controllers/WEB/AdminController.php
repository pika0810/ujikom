...
class AdminController extends Controller
{
    ...
    // CRUD PENGEMBALIAN
   // 1. menampilkan daftar pengembalian & riwayatnya
   public function indexPengembalian(Request $request)
    {
        $search = $request->input('search');

        // Mengambil transaksi pengembalian beserta relasi peminjaman & user
    ...
    // 2. Menampilkan form proses pengembalian (memilih transaksi peminjaman aktif)
    public function createPengembalian()
    {
        // Hanya ambil transaksi yang statusnya 'dipinjam' atau 'telat'
    ...
    // 3. Memproses pengembalian alat, menghitung denda, & memulihkan stok
    public function storePengembalian(Request $request)
    {
        $request->validate([
            ...
            'denda_total'  => 'nullable|integer|min:0',
        ...
        try {
            ...
            // Jika denda manual diisi dan > 0, pakai denda manual
            if ($request->filled('denda_manual') && $request->denda_manual > 0) {
                $totalDenda = $request->denda_manual;
            } else {
                // Hitung otomatis berdasarkan tarif harian
            ...
            // 1. Simpan data ke tabel pengembalians
            Pengembalian::create([
                'peminjaman_id' => $peminjaman->id,
            ...
            // 3. Pulihkan (tambahkan kembali) stok alat ke inventaris
            $details = $peminjaman->detailPinjam ?? $peminjaman->detailPeminjaman ?? [];
            foreach ($peminjaman->detailPinjam as $detail) {
    ...
    // 4. Menghapus data riwayat pengembalian
